...
set_method_bisect = {"bisect_left", "bisect_right", "insort_left", "insort_right"}
...
def get_var3(list1, dic_var, list_tmp, dic_rename):
    ...
    if list_tmp[0] == 272:
        ...
        for index1 in range(1, len(list_tmp)):
            ...
            if list2[0] == 323:
                ...
                pcnt = 0
                for index2 in range(2, len(list2)):
                    if list2[index2][0] == 326 and list1[2][1][0] == 9:
                        pcnt += 1
                str_name = list2[1][1] + pcnt * "*"
    ...
    if list_tmp[0] == 299:
        ...
        set_space_cpx = setunion(set_space_cpx, list_tmp[6][-1][2])
    ...
    if list_tmp[0] == 323:
        ...
        if list_tmp[1][1] == "set":
            ...
            if list_tmp[2][2][0] == 323:
                print("list_tmp[2][2]", list_tmp[2][2])
                str_name, indentnum, f_ref = getIndexDepth(dic_var, list_tmp[2][2])
                print(str_name, indentnum, f_ref)
            ...
            if str_name in dic_var:
                ...
                set_timecpx = set()
                set_spacecpx = set()
            return ["exp:func:set", set_timecpx, set_spacecpx]
        # list
        if list_tmp[1][1] == "list":
            ...
            if str_name in dic_var:
                ...
                set_timecpx = set()
                set_spacecpx = set()
            return ["exp:func:list", set_timecpx, set_spacecpx]
        ...
        if list_tmp[1][1] == "sorted":
            set1 = lagarithmize(list_tmp[2][2][-1][2])
        ...
        if list_tmp[2][1][0] == 9: 
            ...
            if f_ref is True: 
                if str_name in dic_var:
                    return ["exp:ref*", dic_var[str_name][1], dic_var[str_name][2]]
                return ["exp:ref", set(), set()]
        ...
        if list_tmp[1][1] == dic_rename["bisect"]:
            if list_tmp[2][2][1] in set_method_bisect:
                return ["exp:bisect", lagarithmize(list_tmp[3][2][1][-1][2]), list_tmp[3][2][1][-1][2]]
