...
def adjustAfterwards(list_code, index1, dic_var, dic_rename, f_debug):
    if list_code[1][0] == 1:
        ...
        if list_code[1][1] == "for":
            ...
            if (
                index1 == 4
                and list_code[4][0] == 323
                and list_code[4][1][1] == "enumerate"
            ):
    ...
    if list_tmp[0] == 323:
        ...
        if list_tmp[1][1] == dic_rename["bisect"]:
            if list_tmp[2][2][1] in set_method_bisect:
                set_timecpx = setunion(
                    logarithmize(list_tmp[3][2][1][-1][2]), list_tmp[3][2][3][-1][1]
                )
                set_spacecpx = setunion(
                    list_tmp[3][2][1][-1][2], list_tmp[3][2][3][-1][2]
                )
...
def compareStrValue(str_value1, str_value2, list_pvalue):
    ...
    f1 = getSetValueFromStrValue(tup_value1[1]) >= getSetValueFromStrValue(
        tup_value2[1]
    )
